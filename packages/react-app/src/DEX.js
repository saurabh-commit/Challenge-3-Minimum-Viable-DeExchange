...
const contractName = "YourDEX"
const tokenName = "YourContract"

export default function DEX(props) {
  console.log("DEX Local Provider",props.localProvider, "props.address", props.address, "props.injectedProvider", props.injectedProvider)
  const tx = Transactor(props.injectedProvider,props.gasPrice)

  const localBlockNumber = useBlockNumber(props.localProvider)
  console.log("useBalance 1")
  const localBalance = useBalance(props.address,props.localProvider)

  const writeContracts = useContractLoader(props.injectedProvider);

//   console.log("props", props)
//   console.log("props.readContracts", props.readContracts)
//   if (props.readContracts) {
//       console.log("contractName", contractName);
//       console.log("props.readContracts?props.readContracts.contractName", props.readContracts[contractName].address)
//   }
  const contractAddress = props.readContracts?props.readContracts[contractName].address:""
//   console.log("contractAddress", contractAddress)
  console.log("useBalance 2")
...
// }
// const tokenBalanceFloat = 0
  console.log("useBalance 3")
  const ethBalance = useBalance(contractAddress, props.localProvider)
//   console.log("ethBalance", ethBalance)
//   console.log("contractAddress", contractAddress)
//   console.log("props.localProvider", props.localProvider)
